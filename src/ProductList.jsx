...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        ...
        // REMOVED: setAddedToCart logic
    };

    // NEW FUNCTION: Checks if a product is in the cart based on its name
    const isProductInCart = (productName) => {
        return cartItems.some(item => item.name === productName);
    }
    
    // ... (rest of plantsArray and styles remain the same) ...
    const plantsArray = [
        {
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <span style={{ color: 'white', fontSize: '30px', fontWeight: 'bold', marginLeft: '-5px', marginRight: "10px" }}>{cartItemCount}</span> 
                    </div>
                </div>
            </div>
            {!showCart ? (
                            ...
                            <div key={index}> 
                                ...
                                {category.plants.map((plant, plantIndex) => ( 
                                    ...
                                    <button
                                        ...
                                        // Dynamic text/style based on whether the product is in the Redux cart
                                        style={{ backgroundColor: isProductInCart(plant.name) ? 'gray' : '#4CAF50' }}
